...
const TestDistributionChart = dynamic(
  () => import("./TestDistributionChart").then((m) => m.TestDistributionChart),
  {
    ssr: false,
    loading: () => (
      <div className="h-56 w-full animate-pulse rounded-xl border border-scholar-100 bg-scholar-50" />
    ),
  }
);
      ...
      {analytics.appearedCount > 0 && (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <Card className="p-5 lg:col-span-2">
            ...
            <TestDistributionChart distribution={analytics.distribution} />
          </Card>
