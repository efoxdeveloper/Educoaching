...
export const STAFF_PERMISSIONS_CATALOG: PermissionCategory[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "expenses:write", label: "Manage Expenses", description: "Log daily office and branch expenses" },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "branches:write", label: "Branches", description: "Configure multi-Branch locations" },
